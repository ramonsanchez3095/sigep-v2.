...
export const D3_TABLES: D3TableDefinition[] = [
  ...
  {
    tableId: 'd3-homicidios-dolosos',
    title: 'Homicidios Dolosos',
    sectionId: 'homicidios',
    description: 'Estadísticas de hechos de homicidios dolosos clasificadas por ámbito/situación y móvil de crimen.',
    rows: [
      // Ámbito / Situación
      ...
      // Totales por regional
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-dolosos', 'movil_interpersonal_urc'),
            ref('d3-homicidios-dolosos', 'movil_intrafamiliar_urc'),
            ref('d3-homicidios-dolosos', 'movil_defensa_urc'),
            ref('d3-homicidios-dolosos', 'movil_robo_urc'),
            ref('d3-homicidios-dolosos', 'movil_policial_urc'),
            ref('d3-homicidios-dolosos', 'movil_ajuste_urc'),
            ref('d3-homicidios-dolosos', 'movil_femicidio_urc'),
            ref('d3-homicidios-dolosos', 'movil_pasional_urc'),
            ref('d3-homicidios-dolosos', 'movil_rina_urc'),
            ref('d3-homicidios-dolosos', 'movil_encierro_urc'),
            ref('d3-homicidios-dolosos', 'movil_preterintencional_urc'),
            ref('d3-homicidios-dolosos', 'movil_culposo_urc'),
            ref('d3-homicidios-dolosos', 'movil_sin_factor_urc'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-dolosos', 'movil_interpersonal_urn'),
            ref('d3-homicidios-dolosos', 'movil_intrafamiliar_urn'),
            ref('d3-homicidios-dolosos', 'movil_defensa_urn'),
            ref('d3-homicidios-dolosos', 'movil_robo_urn'),
            ref('d3-homicidios-dolosos', 'movil_policial_urn'),
            ref('d3-homicidios-dolosos', 'movil_ajuste_urn'),
            ref('d3-homicidios-dolosos', 'movil_femicidio_urn'),
            ref('d3-homicidios-dolosos', 'movil_pasional_urn'),
            ref('d3-homicidios-dolosos', 'movil_rina_urn'),
            ref('d3-homicidios-dolosos', 'movil_encierro_urn'),
            ref('d3-homicidios-dolosos', 'movil_preterintencional_urn'),
            ref('d3-homicidios-dolosos', 'movil_culposo_urn'),
            ref('d3-homicidios-dolosos', 'movil_sin_factor_urn'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-dolosos', 'movil_interpersonal_urs'),
            ref('d3-homicidios-dolosos', 'movil_intrafamiliar_urs'),
            ref('d3-homicidios-dolosos', 'movil_defensa_urs'),
            ref('d3-homicidios-dolosos', 'movil_robo_urs'),
            ref('d3-homicidios-dolosos', 'movil_policial_urs'),
            ref('d3-homicidios-dolosos', 'movil_ajuste_urs'),
            ref('d3-homicidios-dolosos', 'movil_femicidio_urs'),
            ref('d3-homicidios-dolosos', 'movil_pasional_urs'),
            ref('d3-homicidios-dolosos', 'movil_rina_urs'),
            ref('d3-homicidios-dolosos', 'movil_encierro_urs'),
            ref('d3-homicidios-dolosos', 'movil_preterintencional_urs'),
            ref('d3-homicidios-dolosos', 'movil_culposo_urs'),
            ref('d3-homicidios-dolosos', 'movil_sin_factor_urs'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-dolosos', 'movil_interpersonal_ure'),
            ref('d3-homicidios-dolosos', 'movil_intrafamiliar_ure'),
            ref('d3-homicidios-dolosos', 'movil_defensa_ure'),
            ref('d3-homicidios-dolosos', 'movil_robo_ure'),
            ref('d3-homicidios-dolosos', 'movil_policial_ure'),
            ref('d3-homicidios-dolosos', 'movil_ajuste_ure'),
            ref('d3-homicidios-dolosos', 'movil_femicidio_ure'),
            ref('d3-homicidios-dolosos', 'movil_pasional_ure'),
            ref('d3-homicidios-dolosos', 'movil_rina_ure'),
            ref('d3-homicidios-dolosos', 'movil_encierro_ure'),
            ref('d3-homicidios-dolosos', 'movil_preterintencional_ure'),
            ref('d3-homicidios-dolosos', 'movil_culposo_ure'),
            ref('d3-homicidios-dolosos', 'movil_sin_factor_ure'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-dolosos', 'movil_interpersonal_uro'),
            ref('d3-homicidios-dolosos', 'movil_intrafamiliar_uro'),
            ref('d3-homicidios-dolosos', 'movil_defensa_uro'),
            ref('d3-homicidios-dolosos', 'movil_robo_uro'),
            ref('d3-homicidios-dolosos', 'movil_policial_uro'),
            ref('d3-homicidios-dolosos', 'movil_ajuste_uro'),
            ref('d3-homicidios-dolosos', 'movil_femicidio_uro'),
            ref('d3-homicidios-dolosos', 'movil_pasional_uro'),
            ref('d3-homicidios-dolosos', 'movil_rina_uro'),
            ref('d3-homicidios-dolosos', 'movil_encierro_uro'),
            ref('d3-homicidios-dolosos', 'movil_preterintencional_uro'),
            ref('d3-homicidios-dolosos', 'movil_culposo_uro'),
            ref('d3-homicidios-dolosos', 'movil_sin_factor_uro'),
          ],
        },
      },
    ],
  ...
  {
    tableId: 'd3-homicidios-victimas',
    title: 'Cantidad de Víctimas por Móvil de Crimen',
    sectionId: 'homicidios',
    description: 'Estadísticas de cantidad de víctimas por móvil de crimen.',
    rows: [
      // Ámbito / Situación
      { kind: 'editable', rowId: 'ambito_publico_urc', label: 'ÁMBITO PÚBLICO - U.R.C' },
      { kind: 'editable', rowId: 'ambito_publico_urn', label: 'ÁMBITO PÚBLICO - U.R.N' },
      ...
      // Totales por regional
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-victimas', 'movil_interpersonal_urc'),
            ref('d3-homicidios-victimas', 'movil_intrafamiliar_urc'),
            ref('d3-homicidios-victimas', 'movil_defensa_urc'),
            ref('d3-homicidios-victimas', 'movil_robo_urc'),
            ref('d3-homicidios-victimas', 'movil_policial_urc'),
            ref('d3-homicidios-victimas', 'movil_ajuste_urc'),
            ref('d3-homicidios-victimas', 'movil_femicidio_urc'),
            ref('d3-homicidios-victimas', 'movil_pasional_urc'),
            ref('d3-homicidios-victimas', 'movil_rina_urc'),
            ref('d3-homicidios-victimas', 'movil_encierro_urc'),
            ref('d3-homicidios-victimas', 'movil_preterintencional_urc'),
            ref('d3-homicidios-victimas', 'movil_culposo_urc'),
            ref('d3-homicidios-victimas', 'movil_sin_factor_urc'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-victimas', 'movil_interpersonal_urn'),
            ref('d3-homicidios-victimas', 'movil_intrafamiliar_urn'),
            ref('d3-homicidios-victimas', 'movil_defensa_urn'),
            ref('d3-homicidios-victimas', 'movil_robo_urn'),
            ref('d3-homicidios-victimas', 'movil_policial_urn'),
            ref('d3-homicidios-victimas', 'movil_ajuste_urn'),
            ref('d3-homicidios-victimas', 'movil_femicidio_urn'),
            ref('d3-homicidios-victimas', 'movil_pasional_urn'),
            ref('d3-homicidios-victimas', 'movil_rina_urn'),
            ref('d3-homicidios-victimas', 'movil_encierro_urn'),
            ref('d3-homicidios-victimas', 'movil_preterintencional_urn'),
            ref('d3-homicidios-victimas', 'movil_culposo_urn'),
            ref('d3-homicidios-victimas', 'movil_sin_factor_urn'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-victimas', 'movil_interpersonal_urs'),
            ref('d3-homicidios-victimas', 'movil_intrafamiliar_urs'),
            ref('d3-homicidios-victimas', 'movil_defensa_urs'),
            ref('d3-homicidios-victimas', 'movil_robo_urs'),
            ref('d3-homicidios-victimas', 'movil_policial_urs'),
            ref('d3-homicidios-victimas', 'movil_ajuste_urs'),
            ref('d3-homicidios-victimas', 'movil_femicidio_urs'),
            ref('d3-homicidios-victimas', 'movil_pasional_urs'),
            ref('d3-homicidios-victimas', 'movil_rina_urs'),
            ref('d3-homicidios-victimas', 'movil_encierro_urs'),
            ref('d3-homicidios-victimas', 'movil_preterintencional_urs'),
            ref('d3-homicidios-victimas', 'movil_culposo_urs'),
            ref('d3-homicidios-victimas', 'movil_sin_factor_urs'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-victimas', 'movil_interpersonal_ure'),
            ref('d3-homicidios-victimas', 'movil_intrafamiliar_ure'),
            ref('d3-homicidios-victimas', 'movil_defensa_ure'),
            ref('d3-homicidios-victimas', 'movil_robo_ure'),
            ref('d3-homicidios-victimas', 'movil_policial_ure'),
            ref('d3-homicidios-victimas', 'movil_ajuste_ure'),
            ref('d3-homicidios-victimas', 'movil_femicidio_ure'),
            ref('d3-homicidios-victimas', 'movil_pasional_ure'),
            ref('d3-homicidios-victimas', 'movil_rina_ure'),
            ref('d3-homicidios-victimas', 'movil_encierro_ure'),
            ref('d3-homicidios-victimas', 'movil_preterintencional_ure'),
            ref('d3-homicidios-victimas', 'movil_culposo_ure'),
            ref('d3-homicidios-victimas', 'movil_sin_factor_ure'),
          ],
        },
      },
      {
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-victimas', 'movil_interpersonal_uro'),
            ref('d3-homicidios-victimas', 'movil_intrafamiliar_uro'),
            ref('d3-homicidios-victimas', 'movil_defensa_uro'),
            ref('d3-homicidios-victimas', 'movil_robo_uro'),
            ref('d3-homicidios-victimas', 'movil_policial_uro'),
            ref('d3-homicidios-victimas', 'movil_ajuste_uro'),
            ref('d3-homicidios-victimas', 'movil_femicidio_uro'),
            ref('d3-homicidios-victimas', 'movil_pasional_uro'),
            ref('d3-homicidios-victimas', 'movil_rina_uro'),
            ref('d3-homicidios-victimas', 'movil_encierro_uro'),
            ref('d3-homicidios-victimas', 'movil_preterintencional_uro'),
            ref('d3-homicidios-victimas', 'movil_culposo_uro'),
            ref('d3-homicidios-victimas', 'movil_sin_factor_uro'),
          ],
        },
      },
    ],
  ...
  {
    tableId: 'd3-homicidios-resumen',
    title: 'Resumen de Homicidios Dolosos',
    sectionId: 'homicidios',
    rows: [
      {
        kind: 'computed',
        rowId: 'total_homicidios',
        label: 'TOTAL DE HOMICIDIOS',
        emphasis: 'total',
        formula: {
          type: 'sum',
          refs: [
            ref('d3-homicidios-dolosos', 'totales_urc'),
            ref('d3-homicidios-dolosos', 'totales_urn'),
            ref('d3-homicidios-dolosos', 'totales_urs'),
            ref('d3-homicidios-dolosos', 'totales_ure'),
            ref('d3-homicidios-dolosos', 'totales_uro'),
          ],
        },
      },
    ],
