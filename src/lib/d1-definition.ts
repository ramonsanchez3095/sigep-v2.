...
export const D1_TABLES: D1TableDefinition[] = [
  ...
  },
  {
    ...
    sectionId: 'situaciones-administrativas',
    rows: [
      { kind: 'editable', rowId: 'jubilaciones', label: 'JUBILACIONES' },
      { kind: 'editable', rowId: 'pensiones', label: 'PENSIONES' },
      {
        kind: 'computed',
        ...
        formula: {
          type: 'sum',
          refs: [
            ref('d1-otras-situaciones', 'jubilaciones'),
            ref('d1-otras-situaciones', 'pensiones'),
          ],
        },
      },
    ],
  ...
  {
    tableId: 'd1-cuadro-comparativo',
    title: 'Cuadro comparativo',
    sectionId: 'situaciones-administrativas',
    rows: [
      { kind: 'editable', rowId: 'normales', label: 'NORMALES' },
      { kind: 'editable', rowId: 'administrativas', label: 'ADMINISTRATIVAS' },
      { kind: 'editable', rowId: 'baja_laboral_art', label: 'BAJA LABORAL (ART)' },
      {
        kind: 'computed',
        rowId: 'total_cuadro_comparativo',
        label: 'TOTAL',
        emphasis: 'total',
        formula: {
          type: 'sum',
          refs: [
            ref('d1-cuadro-comparativo', 'normales'),
            ref('d1-cuadro-comparativo', 'administrativas'),
            ref('d1-cuadro-comparativo', 'baja_laboral_art'),
          ],
        },
      },
    ],
  ...
  {
    tableId: 'd1-ascensos-proyeccion',
    title: 'ASCENSOS Y SU PROYECCIÓN',
    sectionId: 'situaciones-administrativas',
    variant: 'comparison-share',
    shareBase: ref('d1-ascensos-proyeccion', 'total_ascensos_proyeccion'),
    shareLabel: 'PORCENTAJE',
    rows: [
      { kind: 'editable', rowId: 'crio_gral', label: 'CRIO. GRAL.' },
      { kind: 'editable', rowId: 'crio_my', label: 'CRIO. MY.' },
      { kind: 'editable', rowId: 'crio_insp', label: 'CRIO. INSP.' },
      { kind: 'editable', rowId: 'crio_ppal', label: 'CRIO. PPAL.' },
      { kind: 'editable', rowId: 'comisario', label: 'COMISARIO' },
      { kind: 'editable', rowId: 'subcrio', label: 'SUBCRIO.' },
      { kind: 'editable', rowId: 'of_ppal', label: 'OF. PPAL.' },
      { kind: 'editable', rowId: 'of_aux', label: 'OF. AUX.' },
      { kind: 'editable', rowId: 'of_ayte', label: 'OF. AYTE.' },
      { kind: 'editable', rowId: 'subof_my', label: 'SUBOF. MY' },
      { kind: 'editable', rowId: 'subof_ppal', label: 'SUBOF. PPAL.' },
      { kind: 'editable', rowId: 'sgto_ayte', label: 'SGTO. AYTE.' },
      { kind: 'editable', rowId: 'sgto_1', label: 'SGTO. 1°' },
      { kind: 'editable', rowId: 'sgto', label: 'SGTO.' },
      { kind: 'editable', rowId: 'cabo_1', label: 'CABO 1°' },
      { kind: 'editable', rowId: 'cabo', label: 'CABO' },
      { kind: 'editable', rowId: 'agente', label: 'Agente' },
      { kind: 'editable', rowId: 'ptp', label: 'P.T.P.' },
      {
        kind: 'computed',
        rowId: 'total_ascensos_proyeccion',
        label: 'TOTAL',
        emphasis: 'total',
        formula: {
          type: 'sum',
          refs: [
            ref('d1-ascensos-proyeccion', 'crio_gral'),
            ref('d1-ascensos-proyeccion', 'crio_my'),
            ref('d1-ascensos-proyeccion', 'crio_insp'),
            ref('d1-ascensos-proyeccion', 'crio_ppal'),
            ref('d1-ascensos-proyeccion', 'comisario'),
            ref('d1-ascensos-proyeccion', 'subcrio'),
            ref('d1-ascensos-proyeccion', 'of_ppal'),
            ref('d1-ascensos-proyeccion', 'of_aux'),
            ref('d1-ascensos-proyeccion', 'of_ayte'),
            ref('d1-ascensos-proyeccion', 'subof_my'),
            ref('d1-ascensos-proyeccion', 'subof_ppal'),
            ref('d1-ascensos-proyeccion', 'sgto_ayte'),
            ref('d1-ascensos-proyeccion', 'sgto_1'),
            ref('d1-ascensos-proyeccion', 'sgto'),
            ref('d1-ascensos-proyeccion', 'cabo_1'),
            ref('d1-ascensos-proyeccion', 'cabo'),
            ref('d1-ascensos-proyeccion', 'agente'),
            ref('d1-ascensos-proyeccion', 'ptp'),
          ],
        },
      },
    ],
